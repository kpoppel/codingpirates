...
--   dirt, and wood.
--   Once the player has dug up a certain number of blocks, they will have access to
...
core.register_on_dignode(function(pos, oldnode, digger)
    if core.get_node({x=0, y=-1, z=0}).name == "air" then
        -- NEW: Update world data and check if the player has progressed
...
core.register_on_craft(function(itemstack, player, old_craft_grid, craft_inv)
    ...
    -- NEW: Crafting no longer means anything
